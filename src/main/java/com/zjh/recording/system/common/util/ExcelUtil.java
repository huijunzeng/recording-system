...
public class ExcelUtil {
    ...
    private static List<String> FORMATS = Arrays.asList(XLS, XLSX);
    ...
    public static void checkFileFormat(String fileName) {
        checkFileFormat(fileName, FORMATS);
    }
     ...
     * @return
     */
    public static void checkFileFormat(String fileName, List<String> formats) {
        String fileFormat = fileName.substring(fileName.lastIndexOf("."));
        if (!formats.contains(fileFormat)) {
            throw new BusinessException(SystemExceptionEnums.IMPORT_EXCLE_FORMAT_ERROR);
        }
    }
